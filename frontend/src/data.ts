...
let data: any = {
  defaultData: {
    ...
    OrderDetails: [
      { orderNumber: 1, line: 1, product: 1, price: 0.62, quantity: 1, id: 43 },
      { orderNumber: 2, line: 2, product: 2, price: 0.4, quantity: 2, id: 56 },
      { orderNumber: 3, line: 3, product: 3, price: 0.3, quantity: 3, id: 29 },
      { orderNumber: 4, line: 4, product: 4, price: 0.88, quantity: 4, id: 15 },
      { orderNumber: 5, line: 5, product: 5, price: 0.08, quantity: 5, id: 99 },
    ],
    Payments: [
      {
        orderNumber: 1,
